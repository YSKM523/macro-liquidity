...
| PR-09 | 已完成（本地） | `0764210`–`f07552f` | event-time 首个可交易日收盘、日频 NAV、SOFR/成本、typed incomplete 与 UI 披露；29 files / 503 tests |
...
- [x] fresh 0001–0009 migration 与二次 no-op、29 files / 503 tests、TypeScript strict、diff-check
