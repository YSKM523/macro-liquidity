...
| PR-12 | 已完成（本地） | `7f64d10`–`9258a0a` | 动态准备金 prior-only challenger、独立 freshness/state/OOS 与 schema-v2 双源 artifact；32 files / 633 tests、TypeScript、migration twice 已通过，待独立复审；结论 `DROP_RESEARCH`，replacementEligible=false，Champion 不变 |
