...
- Registered the forward holdout at `2026-07-22T19:37:28Z` from commit `75c93d526bf6073440335d3c90a7d5c0b90ea58b`, with execution-date membership beginning `2026-07-23` and a digest binding the fixed Champion identity and complete protocol. No truthful tail threshold existed at registration, so prospective tail remains permanently `UNAVAILABLE_AT_REGISTRATION`; direction/verdict/risk/IC remain `PENDING_MATURITY` until five post-registration labels mature.
