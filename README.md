...
- 测试:**Vitest**(472 测试，覆盖模型逻辑、原子摄取、PIT/vintage、冻结 endpoint audit index、provider fallback、锁与 API)
- 部署:`wrangler`
