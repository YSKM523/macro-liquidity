...
Friday anchors use only observations dated on or before Friday. `WRESBAL / 1000` converts millions to billions; FRED GDP is billions annualized; reserve ratio is reserves/GDP × 100. Rate spread basis points are `(rate − IORB) × 100`; `SRFONTSYD` remains billions.
