...
- [x] **Step 1: Write the failing Miniflare tests**
...
- [x] **Step 3: Implement database-current lease SQL**
...
- [x] **Step 1: Write transferred/expired lease regressions**
...
- [x] **Step 3: Add SQL-local fences and rejected-write errors**
...
- [x] **Step 1: Write failing publication regressions**
...
- [x] **Step 1: Write failing health and read-failure tests**
...
- [x] **Step 3: Implement minimal ordering/status changes**
...
- [x] **Step 1: Pin the direct test dependency**
...
- [x] **Step 2: Update RED/GREEN and rollback documentation**
...
- [x] **Step 3: Verify everything fresh**
...
- [x] **Step 4: Commit the complete fix**
