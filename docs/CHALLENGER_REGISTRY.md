...
| PR-17 liquidity structure | Shadow diagnostic | Retrospective governed PIT event-time; no unseen holdout/OOS claim; typed incomplete without an approved policy ledger and complete governed cohort | `SHADOW_ONLY / NO_PROMOTION_THRESHOLD` | No |
